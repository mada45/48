...
$(function () {
  $(document).scroll(function () {
    ...
    $nav.toggleClass('shadows', $(this).scrollTop() > 405)
  });
});
...
$(".filter").change(function(){
  ...
  $(".programs").find(".effect-sarah").hide();
  $(".programs").find(".effect-sarah." + filters).show();
});

$(".filter-pics").change(function(){
	var filters = $.map($(".filter-pics").toArray(), function(e){
		return $(e).val();
	}).join(".");
	$(".all-pics").find(".pictures").hide();
	$(".all-pics").find(".pictures." + filters).show();
  });
